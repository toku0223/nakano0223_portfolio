...
const Footer = () => {
  return (
    <footer
      className="text-black w-screen block"
      style={{ backgroundColor: '#fff', fontFamily: 'Yu Gothic UI' }}
    >
      <div className="container px-6 mb-6 flex flex-col items-center max-w-6xl w-full mx-auto">
        <div className=" text-center" style={{ color: '#2f4f4f' }}>
          <h3 className="footh3 text-3xl font-semibold">
            NakanoWeb制作Portfolio
          </h3>
